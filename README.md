...
2.  Fork this repo, consider whether you would like to keep or change its [license](LICENSE) and then commit to using the [Log](log.md) or the alternative, rapid [R1 Log](r1-log.md) (R1 stands for Round 1) daily ([example](https://github.com/Kallaway/100-days-kallaway-log)).
